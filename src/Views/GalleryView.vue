...
<template>
  ...
  >
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      >
        Event <span class="text-secondary"> Gallery</span>
      </h1>
      <p
        class="text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed opacity-90"
      >
        Explore our comprehensive collection of professional development events,
        workshops, seminars, and networking opportunities designed to advance
