...
<template>
  ...
  >
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      >
        Our <span class="text-secondary">Committees</span>
      </h1>
      <p
        class="text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed opacity-90"
      >
        Meet the dedicated leaders and committee members who shape the future
        and drive our mission forward with passion.
      </p>
    </div>
